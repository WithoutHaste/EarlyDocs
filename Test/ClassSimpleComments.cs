...
namespace Test
{
	...
	public class ClassSimpleComments
    {
		...
		/// <permission cref="ClassSimpleComments()">[Permission Tag] [References Static Constructor] [Short] [One Line] Nulla tincidunt dui eu odio posuere ultricies.</permission>
