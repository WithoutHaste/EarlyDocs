...
nuget sign EarlyDocs.2.0.0-alpha2.nupkg -CertificatePath E:\Adulting\WithoutHasteLLC\Certificates\Comodo_certificate_backup_PKCS12_from_firefox.p12 -Timestamper http://sha256timestamp.ws.symantec.com/sha256/timestamp
...
REM  	nuget install EarlyDocs -Version 2.0.0-alpha2
REM ))
